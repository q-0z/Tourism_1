        	...
        	if($result)
        	{
            		if ($result->num_rows > 0)
            		{
              			...
              			while($row = $result->fetch_assoc())
              			{
                            ...
                            $sql = "INSERT INTO reserv (pl_to,pl_from,pl_price,seats,date,user, pass,t_by) VALUES ('".$row["pl_dest"]."','".$row["pl_source"]."','".$row["fare"]."','".$row["seat"]."','".$row["date"]."','".$_SESSION['name']."','".$_SESSION['pass']."','train' )";
